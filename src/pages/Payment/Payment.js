...
const Payment = () => {
  ...
  if (creatingPayment || paymentCreated) {
    ...
    return (
      <Grid container direction="column" sx={{alignItems:"center", padding: "1em", gap: "1em"}}>
                  ...
                  <CardContent>
                    ...
                    <div style={{ padding: "0px 1em", fontSize: "1.125em" }}>
                      ...
                      <Typography
                        sx={{ marginBottom: "0.4em", fontSize: "inherit" }}
                      >
                        Este curso esta pensando para personas sin experiencia
                        en programación ni robótica, cualquiera que tenga ganas
                        puede aprender.
                      </Typography>
                      ...
                      <Typography
                        sx={{ marginBottom: "0.4em", fontSize: "inherit" }}
                      >
                        El curso de programación de robótica con Python incluye
                        el material docente y acceso a nuestro simulador de
                        robótica web por 4 meses.
                      </Typography>
                    </div>
                    <DividerTitle sx={{ marginBottom: "1em" }}>
                      Unidades
                    ...
                    <ul style={{ marginTop: "0.4em", fontSize: "1.125em" }}>
                      ...
                      <ul>
                        <li>
                          ...
                          algoritmos. Estos conceptos se aplican para resolver
                          dos ejercicios de movimiento del robot.
                        </li>
                      </ul>
                      ...
                      <ul>
                        <li>
                          A partir del conocimiento del uso de sensores y
                          control del robot, aprenderás el concepto de control
                          automático. El desafío principal es lograr que el
                          robot por si solo, siga un camino definido sin
                          perderse.
                        </li>
                      </ul>
                    ...
                    <ul style={{ fontSize: "1.125em" }}>
                      <li>
                        La compra del curso da acceso al material docente y
                        acceso por 4 meses a la plataforma de robótica virtual
                        web.
                      </li>
                      <li>
                      ...
                      <li>
                        Tendrás acceso a un chat de ayuda para resolver tus
                        dudas del curso.
                      </li>
                    </ul>
